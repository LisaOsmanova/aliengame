<template>
  <div id="app" class="container">
    ...
    <section v-else-if="uiState === 'charachterChosen'">
    ...
    <GamestateFinish v-else @start-game="handleStartGame"> </GamestateFinish>
  </div>
</template>
...
export default {
  ...
  methods: {
    pickCharacter() {
      ...
      this.$store.commit("updateUIState", "charachterChosen");
    },
...
./components/ZombieCharacter.vue
